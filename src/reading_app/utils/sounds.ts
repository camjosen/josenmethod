...
export const soundDefinitionSchema = z.object({
  ...
  long_vowel: z.boolean().optional(),
  digraph: z.boolean().optional(),
});
...
export const sounds = {
  ...
  a_long: { name: "a_long", characters: "a",   as_in: "ate",  long_vowel: true },
  e_long: { name: "e_long", characters: "e",   as_in: "eat",  long_vowel: true },
  i_long: { name: "i_long", characters: "i",   as_in: "ice",  long_vowel: true },
  o_long: { name: "o_long", characters: "o",   as_in: "over", long_vowel: true },
  u_long: { name: "u_long", characters: "u",   as_in: "use",  long_vowel: true },
  y_long: { name: "y_long", characters: "y",   as_in: "my",   long_vowel: true },

  // special vowel sounds
  oo: { name: "oo", characters: "oo",  as_in: "moon", digraph: true },
  ea: { name: "ea", characters: "ea",  as_in: "eat",  digraph: true },
  ai: { name: "ai", characters: "ai",  as_in: "rain", digraph: true },
  ay: { name: "ay", characters: "ay",  as_in: "day",  digraph: true },
  ee: { name: "ee", characters: "ee",  as_in: "see",  digraph: true },
  ou: { name: "ou", characters: "ou",  as_in: "loud", digraph: true },
  ow: { name: "ow", characters: "ow",  as_in: "cow",  digraph: true },

  // consonants voiced and held
  m:   { name: "m",   characters: "m",   as_in: "man" },
  mm:  { name: "mm",  characters: "mm",  as_in: "swimming", digraph: true },
  r:   { name: "r",   characters: "r",   as_in: "run" },
  th:  { name: "th",  characters: "th",  as_in: "this",     digraph: true },
  n:   { name: "n",   characters: "n",   as_in: "no" },
  l:   { name: "l",   characters: "l",   as_in: "late" },
  ll:  { name: "ll",  characters: "ll",  as_in: "bill",     digraph: true },
  w:   { name: "w",   characters: "w",   as_in: "we" },
  I:   { name: "I",   characters: "I",   as_in: "I" },
  v:   { name: "v",   characters: "v",   as_in: "very" },
  ar:  { name: "ar",  characters: "ar",  as_in: "arm",      digraph: true },
  ing: { name: "ing", characters: "ing", as_in: "sing" },
  y:   { name: "y",   characters: "y",   as_in: "yes" },
  er:  { name: "er",  characters: "er",  as_in: "brother",  digraph: true },
  qu:  { name: "qu",  characters: "qu",  as_in: "quick",    digraph: true },
  z:   { name: "z",   characters: "z",   as_in: "buzz" },

  // voiced but not held
  d:  { name: "d",  characters: "d",  as_in: "mad",     stop: true },
  g:  { name: "g",  characters: "g",  as_in: "tag",     stop: true },
  gg: { name: "gg", characters: "gg", as_in: "digging", stop: true, digraph: true },
  b:  { name: "b",  characters: "b",  as_in: "grab",    stop: true },
  j:  { name: "j",  characters: "j",  as_in: "judge",   stop: true },
  wh: { name: "wh", characters: "wh", as_in: "why",     stop: true, digraph: true },

  // whispered and held consonants
  s:  { name: "s",  characters: "s",  as_in: "sat",  whispered: true },
  ss: { name: "ss", characters: "ss", as_in: "kiss", whispered: true, digraph: true },
  f:  { name: "f",  characters: "f",  as_in: "fun",  whispered: true },
  ff: { name: "ff", characters: "ff", as_in: "biff", whispered: true, digraph: true },
  sh: { name: "sh", characters: "sh", as_in: "she",  whispered: true, digraph: true },

  // whispered but not held consonants
  t:  { name: "t",  characters: "t",  as_in: "cat",      whispered: true, stop: true },
  tt: { name: "tt", characters: "tt", as_in: "mitt",     whispered: true, stop: true, digraph: true },
  c:  { name: "c",  characters: "c",  as_in: "tack",     whispered: true, stop: true },
  ck: { name: "ck", characters: "ck", as_in: "back",     whispered: true, stop: true, digraph: true },
  ...
  pp: { name: "pp", characters: "pp", as_in: "stopping", whispered: true, stop: true, digraph: true },
  ch: { name: "ch", characters: "ch", as_in: "touch",    whispered: true, stop: true, digraph: true },
