...
export const READ_SOUNDS_TOOL_PROMPT = `Use this tool to introduce new sounds and review sounds the student already knows.

Usage notes:

- Use "introduction" only for sounds the student has never seen before. Introduce one or two new sounds at a time.
