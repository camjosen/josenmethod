import { SayIt } from "../tools/SayItTool/SayItTool.ts";
...
const tools = [SayIt, ReadSoundsTool, ReadWordsTool, RhymeTool, WriteItTool] as const;
...
export const lessons: { title: string; activities: Activity[] }[] = [
  {
    ...
    activities: [
      ...
      ["SayIt", { variant: "fast", scaffold: true, items: [["motor", "boat"], ["ice", "cream"], ["sis", "ter"], ["ham", "burger"], w.me, w.if] }],
      ["SayIt", { variant: "slow", scaffold: true, items: [w.am, w.if, w.in] }],
      ["ReadSounds", { variant: "recall", items: [s.m, s.s] }],
      ["SayIt", { variant: "fast", items: [["motor", "cycle"], w.me, w.if, w.she] }],
  ...
  },
  {
    ...
    activities: [
      ...
      ["SayIt", { variant: "fast", scaffold: true, items: [["lawn", "mower"], ["side", "walk"], w.if, w.me, w.am, w.in, w.she] }],
      ["SayIt", { variant: "slow", scaffold: true, items: [w.she, w.on, w.if, w.ship] }],
      ["ReadSounds", { variant: "recall", items: [s.m, s.s] }],
      ["SayIt", { variant: "slow", items: [w.man, w.will, w.she, w.sit] }],
  ...
  },
  {
    ...
    activities: [
      ...
      ["SayIt", { variant: "slow", items: [w.run, w.man, w.this, w.we] }],
      ["ReadSounds", { variant: "recall", sayItFast: true, items: [s.m, s.a, s.s] }], // HERE I AM
      ["SayIt", { variant: "slow_then_fast", items: [w.me, w.man, w.if, w.we] }],
  ...
  },
  {
    ...
    activities: [
      ["ReadSounds", { variant: "recall", items: [s.m, s.a, s.s] }],
      ["SayIt", { variant: "fast", items: [w.at, w.eat, w.mat, w.this, w.run, w.not, w.that, w.we] }],
      ["ReadSounds", { variant: "recall", sayItFast: true, items: [s.s, s.m, s.a] }], // Student says sounds slowly, then fast.
      ["SayIt", { variant: "slow_then_fast", items: [w.run, w.at, w.not, w.this, w.mat] }], // me slow -> you slow -> you fast
      [
        "ReadWords",
        {
          variant: "default",
      ...
      ], // me slow (student uses finger but doesn't say anything, NUX?)
  ...
  },
  {
    ...
    activities: [
      ...
      ["SayIt", { variant: "slow", items: [w.me, w.see, w.that, w.we, w.and, w.am, w.eat, w.if] }],
      ["SayIt", { variant: "slow_then_fast", items: [w.see, w.that, w.if, w.at, w.am] }], // me slow -> you slow -> you fast
      ["ReadSounds", { variant: "recall", sayItFast: true, items: [s.e_long, s.s, s.m, s.a] }], // Technically "slow then fast"
      ["ReadSounds", { variant: "recall", sayItFast: true, items: [s.e_long, s.s, s.m, s.a] }], // TODO focus on NUX for moving finger
  ...
  },
  {
    title: "Lesson 6",
    activities: [
      ["ReadSounds", { variant: "recall", sayItFast: true, items: [s.e_long, s.s, s.a, s.m] }], // Student says it slowly then fast
      [
        "SayIt",
        {
          variant: "slow",
      ...
      ["ReadSounds", { variant: "recall", sayItFast: true, items: [s.e_long, s.a, s.m, s.s] }], // slow fast
      ["SayIt", { variant: "slow_then_fast", items: [w.at, w.sat, w.feet, w.sin, w.see, w.seen, w.we] }], // Student says slowly, then fast.
  ...
  },
  {
    title: "Lesson 7",
    activities: [
      ["ReadSounds", { variant: "introduce", items: [s.t] }], // Nux for "quick sound" (I like that language)
      ...
      ["SayIt", { variant: "slow", items: [w.see, w.feet, w.seat, w.meat, w.sat, w.at, w.seen] }],
      ["ReadSounds", { variant: "recall", items: [s.m, s.a, s.t, s.s, s.e_long] }],
      ["SayIt", { variant: "slow_then_fast", items: [w.am, w.run, w.not, w.eat, w.see, w.seen, w.seat] }], // Slow then fast
  ...
  },
  {
    ...
    activities: [
      ...
      ["SayIt", { variant: "slow", items: [w.sam, w.if, w.in, w.sun, w.run, w.road, w.meat, w.sit, w.sat, w.rat, w.am, w.ram] }],
      ["ReadSounds", { variant: "recall", sayItFast: true, items: [s.t, s.e_long, s.m, s.s, s.a] }], // slow and then fast (except for "t", which can only be said fast)
      ["SayIt", { variant: "slow_then_fast", items: [w.run, w.rat, w.road, w.that, w.sit, w.sat, w.mat] }], // slow then fast
  ...
  //     ["ReadSounds", { variant: "recall", items: [s.e_long, s.a, s.s, s.m, s.r] }],
  ...
  //     ["WriteItTool", { items: [{ type: "sound", sound: s.r }, { type: "sound", sound: s.m }, { type: "sound", sound: s.a }, { type: "sound", sound: s.s }, { type: "sound", sound: s.e_long }, { type: "sound", sound: s.t }] }],
  //   ],
  // },
];
