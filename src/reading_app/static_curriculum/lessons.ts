...
export const lessons: { title: string; activities: Activity[] }[] = [
  {
    title: "Lesson 1",
    activities: [
      ["ReadSounds", { flow: ["introduction", "say_it_slow", "say_it_slow"], items: [s.m, s.s] }],
      ...
      ["ReadSounds", { flow: ["say_it_slow"], items: [s.m, s.s] }],
  ...
  },
  {
    title: "Lesson 2",
    activities: [
      ["ReadSounds", { flow: ["reintroduction", "say_it_slow", "say_it_slow"], modifications: ["require_touch"], items: [s.m, s.s] }],
  ...
  },
  {
    title: "Lesson 3",
    activities: [
      ["ReadSounds", { flow: ["introduction", "say_it_slow", "say_it_slow"], items: [s.a] }],
      ["ReadSounds", { flow: ["say_it_slow"], items: [s.m, s.a, s.s] }],
      ["VerbalBlending", { variant: "blend", items: [w.run, w.man, w.this, w.we] }],
      ["ReadSounds", { flow: ["say_it_slow", "say_it_fast"], items: [s.m, s.a, s.s] }],
  ...
  },
  {
    ...
    activities: [
      ...
      ["ReadSounds", { flow: ["say_it_slow", "say_it_fast"], items: [s.s, s.m, s.a] }],
  ...
  },
  {
    title: "Lesson 5",
    activities: [
      ["ReadSounds", { flow: ["introduction", "say_it_slow", "say_it_slow"], items: [s.e_long] }],
      ["ReadSounds", { flow: ["say_it_slow"], items: [s.a, s.s, s.m, s.e_long] }],
      ...
      ["ReadSounds", { flow: ["say_it_slow", "say_it_fast"], items: [s.e_long, s.s, s.m, s.a] }],
      ["ReadSounds", { flow: ["say_it_slow", "say_it_fast"], modifications: ["require_touch"], items: [s.e_long, s.s, s.m, s.a] }],
  ...
  },
  {
    title: "Lesson 6",
    activities: [
      ["ReadSounds", { flow: ["say_it_slow", "say_it_fast"], items: [s.e_long, s.s, s.a, s.m] }],
      ...
      ["ReadSounds", { flow: ["say_it_slow", "say_it_fast"], modifications: ["require_touch"], items: [s.e_long, s.a, s.m, s.s] }],
  ...
  },
  {
    title: "Lesson 7",
    activities: [
      ["ReadSounds", { flow: ["introduction", "say_it_slow", "say_it_slow"], items: [s.t] }],
      ["ReadSounds", { flow: ["say_it_slow", "say_it_fast"], items: [s.e_long, s.s, s.m, s.a] }],
      ...
      ["ReadSounds", { flow: ["say_it_slow"], items: [s.m, s.a, s.t, s.s, s.e_long] }],
  ...
  },
  {
    title: "Lesson 8",
    activities: [
      ["ReadSounds", { flow: ["say_it_slow"], items: [s.m, s.e_long, s.t, s.s, s.a] }],
      ...
      ["ReadSounds", { flow: ["say_it_slow", "say_it_fast"], modifications: ["require_touch"], items: [s.t, s.e_long, s.m, s.s, s.a] }],
  ...
  },
  {
    title: "Lesson 9",
    activities: [
      ["ReadSounds", { flow: ["introduction", "say_it_slow", "say_it_slow"], items: [s.r] }],
      ["ReadSounds", { flow: ["say_it_slow"], items: [s.m, s.a, s.s, s.e_long, s.t, s.r] }],
      ...
      ["ReadSounds", { flow: ["say_it_slow", "say_it_fast"], items: [s.e_long, s.a, s.s, s.m, s.r] }],
  ...
  },
  {
    title: "Lesson 10",
    activities: [
      ["ReadSounds", { flow: ["say_it_slow"], items: [s.r, s.m, s.t, s.a, s.s, s.e_long] }],
  ...
  },
  {
    title: "Lesson 11",
    activities: [
      ["ReadSounds", { flow: ["say_it_slow"], items: [s.r, s.a, s.e_long, s.s, s.t, s.m] }],
  ...
  },
  {
    title: "Lesson 12",
    activities: [
      ["ReadSounds", { flow: ["introduction", "say_it_slow", "say_it_slow"], items: [s.d] }],
      ["ReadSounds", { flow: ["say_it_slow"], items: [s.a, s.e_long, s.t, s.r, s.d] }],
  ...
  },
  {
    title: "Lesson 13",
    activities: [
      ["ReadSounds", { flow: ["say_it_slow"], items: [s.s, s.a, s.t, s.d, s.e_long, s.r] }],
      ...
      ["ReadSounds", { flow: ["say_it_slow", "say_it_fast"], modifications: ["require_touch"], items: [s.d, s.r, s.t, s.e_long, s.m] }],
  ...
  // Skip a bunch of lessons for now
  {
    title: "Lesson 52",
    activities: [
      ["ReadSounds", { flow: ["introduction", "say_it_slow", "say_it_slow"], items: [s.e] }],
      ["ReadSounds", { flow: ["say_it_slow"], items: [s.e_long, s.ch, s.p, s.v, s.e, s.o_long, s.k] }],
      ...
      [
        ...
        {
          markup: ["arrows"],
          flow: ["sound_it_out", "read_the_fast_way_with_questions", "picture_comprehension"],
          paragraphs: [
            [
  ...
  },
  {
    title: "Lesson 53",
    activities: [
      ["ReadSounds", { flow: ["say_it_slow"], items: [s.e_long, s.e, s.a_long, s.a, s.o_long, s.o] }],
      ...
      [
        "Story",
        {
          ...
          markup: ["arrows"],
          flow: ["title_reading", "read_the_fast_way_with_questions", "picture_comprehension"],
          paragraphs: [
            [
